...
<body style="overflow: hidden; overflow-y:auto;">
	...
	<c:if test="${not empty resultList}">
		<form:form commandName="searchVO" name="listForm" id="listForm" method="get" cssStyle="padding-bottom: 100px; padding-top: 100px;">
	...
	<script>
		function link_page(pageNo){
			...
			document.getElementById("listForm").action = "<c:url value='/movie/movieSearch'/>";
