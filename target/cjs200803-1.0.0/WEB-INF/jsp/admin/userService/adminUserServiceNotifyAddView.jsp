		               		...
		               		<div class="row">
		                    	<div class="col-sm-12">
		                        	<div class="card-box table-responsive">
		                        		<form:form commandName="notifyVO" action="${contextPath}/admin/userService/notifyAdd">
		                    				<table id="datatable" class="table table-striped table-bordered" style="width:100%">
			                      				<tbody style="font-size: 0.7em;">
			                      					<tr>
								                    	...
								                    	<td>
								                    		<form:input path="notifyTitle" cssClass="form-control"/>
								                    ...
								                    <tr>
								                    	...
								                    	<td>
								                    		<form:radiobuttons path="notifyType" items="${notifyType }"/>
								                    ...
								                    <tr>
								                    	...
								                    	<td>
								                    		<form:textarea path="notifyContent" cssStyle="resize: none; width:100%; height:100px;" cssClass="form-control"/>
								                    ...
								                    <tr>
								                    	<td colspan="2" style="text-align: center;">
								                    		<button type="button" onclick="notifyCheck()" class="btn btn-app">
