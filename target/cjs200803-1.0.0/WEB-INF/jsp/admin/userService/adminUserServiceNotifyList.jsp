...
<body class="nav-md">
        	...
        	<div class="page-title">
            	<div class="title_left">
              	...
              	<div class="title_right" style="text-align: right;">
                	<form:form commandName="searchVO" action="${contextPath}/admin/userService/notifyList" method="get">
              			검색조건
		                      				...
		                      				<tbody style="font-size: 0.7em;">
		                      					<c:forEach var="notify" items="${resultList}" varStatus="formNum">
			                        				<tr>
								                        ...
								                        <td><button class="btn btn-secondary btn-sm" type="button" onclick="location.href='<c:url value="/admin/userService/notifyInfo?notifyIdx=${notify.notifyIdx}&pageIndex=${searchVO.pageIndex}&searchCondition=${searchVO.searchCondition}&searchKeyword=${searchVO.searchKeyword}"/>';">상세보기</button></td>
			                        				</tr>		                      					
		                      					</c:forEach>
		                      				</tbody>
		                    			</table>
    ...
    <script>
    	...
    	function link_page(pageNo){
    		...
    		document.getElementById("listForm").action = "<c:url value='/admin/userService/notifyList'/>";
