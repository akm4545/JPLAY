...
<body class="nav-md">
    	...
    	<div class="">
        	<div class="page-title">
            	<div class="title_left">
                	<h3>공지사항 <small>목록</small></h3>
              	</div>
              	<div class="title_right" style="text-align: right;">
                	<form:form commandName="searchVO" action="${contextPath}/admin/userService/notifyDeleteList" method="get">
              			검색조건
		                        	...
		                        	<div class="card-box table-responsive">
		                    			<table id="datatable" class="table table-striped table-bordered" style="width:100%">
		                      				...
		                      				<tbody style="font-size: 0.7em;">
		                      					<c:forEach var="notify" items="${resultList}" varStatus="formNum">
			                        				<tr>
			                          					<td>
			                          						${notify.notifyIdx}
			                          					</td>
								                        ...
								                        <td><button class="btn btn-secondary btn-sm" type="button" onclick="deleteCheck('${notify.notifyIdx}')">삭제하기</button></td>
			                        				</tr>		                      					
		                      					</c:forEach>
		                      				</tbody>
		                    			</table>
    ...
    <script>
    	...
    	function link_page(pageNo){
    		...
    		document.getElementById("listForm").action = "<c:url value='/admin/userService/notifyDeleteList'/>";
    	   	document.getElementById("listForm").submit();
    	}
    	
    	function deleteCheck(notifyIdx){
    		var res = confirm("정말 삭제하시겠습니까?");
    		if(res){
    			location.href='<c:url value="/admin/userService/notifyDelete?notifyIdx=' + notifyIdx + '&pageIndex=${searchVO.pageIndex}&searchCondition=${searchVO.searchCondition}&searchKeyword=${searchVO.searchKeyword}"/>';
    		}else{
    			return;
    		}
    	}
