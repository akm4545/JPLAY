...
<body class="nav-md">
    	...
    	<div class="">
        	<div class="page-title">
            	<div class="title_left">
                	<h3>답변 <small>목록</small></h3>
              	</div>
              	<div class="title_right" style="text-align: right;">
                	<form:form commandName="searchVO" action="${contextPath}/admin/userService/answerList" method="get">
              			검색조건
		                      				...
		                      				<tbody style="font-size: 0.7em;">
		                      					<c:forEach var="question" items="${resultList}" varStatus="formNum">
			                        				<tr>
							                          	...
							                          	<td>
							                          		${fn:substring(question.qnaAnswerdate,0,11)}
							                          	</td>
								                        <td><button class="btn btn-secondary btn-sm" type="button" onclick="location.href='<c:url value="/admin/userService/answerInfo?qnaIdx=${question.qnaIdx}&pageIndex=${searchVO.pageIndex}&searchCondition=${searchVO.searchCondition}&searchKeyword=${searchVO.searchKeyword}"/>';">상세보기</button></td>
			                        				</tr>		                      					
		                      					</c:forEach>
		                      				</tbody>
		                    			</table>
    ...
    <script>
    	...
    	function link_page(pageNo){
    		...
    		document.getElementById("listForm").action = "<c:url value='/admin/userService/answerList'/>";
