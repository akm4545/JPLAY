...
public class CkFilter implements Filter {
    ...
    private static final String FILE_ALLOW_TYPE_KEY = "ck.file.type.allow";
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		String allowFileType = (String) props.get(FILE_ALLOW_TYPE_KEY);
