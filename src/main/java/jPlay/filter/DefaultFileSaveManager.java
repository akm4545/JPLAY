...
public class DefaultFileSaveManager implements FileSaveManager {
	...
	public String saveFile(FileItem fileItem, String imageBaseDir) {
		...
		String extension = StringUtils.lowerCase(StringUtils.substringAfterLast(originalFileName, "."));
		if(extension.equals("png") || extension.equals("jpg") || extension.equals("jpeg") || extension.equals("gif") || extension.equals("bmp")) {
			fileName = "IMG" + RandomStringUtils.randomAlphanumeric(20) + "." + extension;			
		}else {
			fileName = "VIDEO" + RandomStringUtils.randomAlphanumeric(20) + "." + extension;
		}

		File newFile = new File(imageBaseDir + "\\" + fileName);
//		File newFile = new File(imageBaseDir + fileName);
