...
<body class="nav-md">
    	...
    	<div class="">
        	<div class="page-title">
            	<div class="title_left">
                	<h3>영화 <small>목록</small></h3>
              	</div>
              	<div class="title_right" style="text-align: right;">
                	<form:form commandName="searchVO" action="${contextPath}/admin/movie/movieList" method="get">
              			검색조건
		                        	...
		                        	<div class="card-box table-responsive">
		                    			<table id="datatable" class="table table-striped table-bordered" style="width:100%">
		                      				...
		                      				<tbody style="font-size: 0.7em;">
		                      					<c:forEach var="movie" items="${resultList}" varStatus="formNum">
			                        				<tr>
			                          					<td>
			                          						${movie.movieIdx}
			                          					</td>
							                          	...
							                          	<td>
							                          		${fn:substring(movie.movieOpeningdate,0,11)}
							                          	</td>
							                          	<td>
							                          		${movie.movieRating}
							                          	</td>
							                          	...
							                          	<td>
							                          		${movie.movieViewcount}
							                          	</td>
								                        <td>
								                        	<button class="btn btn-secondary btn-sm" type="button" onclick="deleteCheck('${movie.movieIdx}')">삭제하기</button>
								                        </td>
			                        				</tr>		                      					
		                      					</c:forEach>
		                      				</tbody>
    ...
    <script>
    	...
    	function link_page(pageNo){
    		...
    		document.getElementById("listForm").action = "<c:url value='/admin/movie/movieDeleteList'/>";
    	   	document.getElementById("listForm").submit();
    	}
    	
    	function deleteCheck(movieIdx){
    		var res = confirm("정말 삭제하시겠습니까?");
    		if(res){
	    		location.href='<c:url value="/admin/movie/movieDelete?movieIdx=' + movieIdx + '&pageIdx=${searchVO.pageIndex}&searchCondition=${searchVO.searchCondition}&searchKeyword=${searchVO.searchKeyword}"/>';    			
    		}
    	}
    </script>
</body>
