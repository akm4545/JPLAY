...
<body class="nav-md">
		               		...
		               		<div class="row">
		                    	<div class="col-sm-12">
		                        	<div class="card-box table-responsive">
		                        		<form:form commandName="adminMovieVO" action="${contextPath}/admin/movie/movieUpdate">
		                    				<table id="datatable" class="table table-striped table-bordered" style="width:100%">
			                      				<tbody style="font-size: 0.7em;">
			                      					<tr>
								                    	...
								                    	<td>
								                    		<form:input path="movieTitle" readonly="true" cssClass="form-control"/>
								                    ...
								                    <tr>
								                    	...
								                    	<td>
								                    		<form:input type="date" path="movieOpeningdate" readonly="true" cssClass="form-control"/>
								                    ...
								                    <tr>
								                    	...
								                    	<td>
								                    		<form:textarea path="movieSynopsis" readonly="true" cssStyle="resize: none; width:100%; height:100px;" cssClass="form-control"/>
								                    ...
								                    <tr>
								                    	...
								                    	<td>
								                    		<form:input path="movieDirector" readonly="true" cssClass="form-control"/>
								                    ...
								                    <tr>
								                    	...
								                    	<td>
								                    		<form:input path="movieActor" readonly="true" cssClass="form-control"/>
								                    ...
								                    <tr>
								                    	...
								                    	<td style="height: 700px;">
								                    		<form:textarea path="fileName" readonly="true"/>
								                     ...
								                     <tr>
								                    	<td colspan="2" style="text-align: center;">
								                    		<button type="button" class="btn btn-app" onclick="movieUpdate()" id="submitBtn" disabled>
						                    				...
						                    				<button type="button" class="btn btn-app" onclick="location.href='<c:url value="/admin/movie/movieList?pageIndex=${adminMovieVO.pageIndex}&searchCondition=${adminMovieVO.searchCondition}&searchKeyword=${adminMovieVO.searchKeyword}"/>';">
    ...
    <script>	
    	...
    	var editor = CKEDITOR.replace( 'fileName', {
    					allowedContent : true,
						toolbar: [{ name: 'basicstyles', items: [ 'Image','Html5video'] }]
					});;
    	var readSw = false;
    	...
    	function movieUpdate(){
			...
			var mat = /img alt=/g;			
			result = content.match(mat);
			
			var	updateMat = /img src=/g;
			updateResult = content.match(updateMat);
			
			if(result != null && updateResult != null){
				alert("이미지 파일의 개수를 확인하세요. 1개여야 합니다.");
				return false;
			}else if(result != null && (result.length != 1 || updateResult != null)){
				alert("이미지 파일의 개수를 확인하세요. 1개여야 합니다.");
				return false;
			}else if(updateResult != null && (updateResult.length != 1 || result != null)){
				alert("이미지 파일의 개수를 확인하세요. 1개여야 합니다.");
				return false;
			}else if(result == null && updateResult == null){
				alert("이미지 파일의 개수를 확인하세요. 1개여야 합니다.");
				return false;
			}
			...
			mat = /ckeditor-html5-video/g;
			result = content.match(mat);
			
			updateMat = /video controls=/g;
			updateResult = content.match(updateMat);
			
			if(result != null){
				if(updateResult != null){
					if(result.length != 1 || updateResult.length != 1){
				...
				if(result == null && updateResult.length != 2){
					alert("동영상 파일의 개수를 확인하세요. 2개여야 합니다.");
					return false;
				}
			}	
		...
		function formChange(){
			$("#movieTitle").attr("readonly", false);
			$("#movieOpeningdate").attr("readonly", false);
			$("#movieSynopsis").attr("readonly", false);
			$("#movieDirector").attr("readonly", false);
			$("#movieActor").attr("readonly", false);
