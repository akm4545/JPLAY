...
<body class="nav-md">
		                      				...
		                      				<tbody style="font-size: 0.7em;">
		                      					<c:forEach var="payment" items="${resultList}" varStatus="formNum">
			                        				<tr>
								                        ...
								                        <td><button class="btn btn-secondary btn-sm" type="button" onclick="location.href='<c:url value="/admin/payment/paymentInfo?paymentIdx=${payment.paymentIdx}&pageIndex=${searchVO.pageIndex}&searchCondition=${searchVO.searchCondition}&searchKeyword=${searchVO.searchKeyword}"/>';">상세보기</button></td>
			                        				</tr>		                      					
		                      					</c:forEach>
		                      				</tbody>
		                    			</table>
    ...
    <script>
    	...
    	function link_page(pageNo){
    		...
    		document.getElementById("listForm").action = "<c:url value='/admin/payment/paymentList'/>";
