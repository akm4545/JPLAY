...
<body class="nav-md">
		               		...
		               		<div class="row">
		                    	<div class="col-sm-12">
		                        	<div class="card-box table-responsive">
		                        		<form:form commandName="qnaVO" action="${contextPath}/admin/userService/answerUpdate">
		                    				<table id="datatable" class="table table-striped table-bordered" style="width:100%">
			                      				<tbody style="font-size: 0.7em;">
								                    ...
								                    <tr>
								                    	...
								                    	<td>
								                    		<form:input type="date" path="qnaAnswerdate" readonly="true" cssClass="form-control"/>
								                    	</td>
								                    </tr>
								                    <tr>
								                    	<th>
								                     ...
								                     <tr>
								                    	<td colspan="2" style="text-align: center;">
						                    				...
						                    				<button type="button" class="btn btn-app" onclick="location.href='<c:url value="/admin/userService//answerList?pageIndex=${qnaVO.pageIndex}&searchCondition=${qnaVO.searchCondition}&searchKeyword=${qnaVO.searchKeyword}"/>';">
    ...
    <script>
    	...
    	/* function movieUpdate(){
			...
			if(!validateAdminMovieVO(memberForm)){
				return false;
			}else{
				memberForm.submit();
			}
